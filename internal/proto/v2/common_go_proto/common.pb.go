...
func file_internal_proto_v2_common_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_internal_proto_v2_common_common_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_internal_proto_v2_common_common_proto_msgTypes[0].OneofWrappers = []interface{}{
